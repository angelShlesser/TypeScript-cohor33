...
import Tesla from "pages/Clients/Tesla/Tesla";
import Nestle from "pages/Clients/Nestle/Nestle";
...
import Homework24 from "homeworks/Homework24/Homehork24";
    ...
    <BrowserRouter>
      ...
      <Layout>
        <Routes>
          ...
          <Route path="/clients/nestle" element={<Nestle />} />
          <Route path="*" element="Page not Out!" />
        </Routes>
      </Layout>
      {/* <Lesson20 /> */}
      {/* <Lesson21 /> */}
